...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 23 14:50:48 2022
...
overview_2022 = pd.read_csv('/Users/ethanmitten/Desktop/Data Analytics/March Madness/Data/MM_2022Overview.csv')
...
def gameSim(team1, team2):
    ...
    xscore = Xscore * data['SOS'].mean() * overview_2022['FG%'].mean()
    Yscore = (rnd.gauss(ymeanpts,ysdpts) + rnd.gauss(xmeanopp, xsdopp))/2
    yscore = Yscore * data['SOS'].mean() * overview_2022['FG%'].mean()
